    ...
    var i = function () {
        ...
        return t.prototype = {
            constructor: t, init: function () {
                ...
                this.$el.children().css({height: "100vh", transition: "all 0.3s", "-webkit-transition": "all 0.3s"})
            }, bindEvent: function () {
                ...
                }, 100)), this.$el.on("touchstart", function (t) {
                ...
                var i, e = this.$el.children(), o = this;
                ...
                }), e.css({transform: i, "-webkit-transform": i}), this.currIndex = t)
            }
        }, t
    }();
